			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone">Tel : <?php echo $ayarcek['ayar_tel'] ?> </li>
						<li class="fmobile">Gsm : <?php echo $ayarcek['ayar_gsm'] ?></li>
						<li class="fmobile">Faks : <?php echo $ayarcek['ayar_faks'] ?></li>
						<li class="fmail lastone">Mail : <?php echo $ayarcek['ayar_mail'] ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author']; ?> <a href="<?php echo $ayarcek['ayar_facebook'] ?>">Ali PERİŞAN Facebook</a></div>
