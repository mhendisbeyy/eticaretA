             ...
             <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="menu_ad" value="<?php echo $ayarcek['ayar_url']?>/sayfa-<?php echo seo($menucek['menu_ad']) ?>"required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <!--
input type="text" id="first-name" name="menu_ad" value="<?php echo $_SERVER['HTTP_HOST']."/".$_SERVER['REQUEST_URI']?>/sayfa-<?php echo seo($menucek['menu_ad']) ?>"required="required" class="form-control col-md-7 col-xs-12">
              -->
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <textarea class="ckeditör" id="editör1"name="menu_detay" ><?php echo $menucek['menu_detay']; ?></textarea>
                 </div>
