  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
   <select id="heard" class="form-control" name="urun_onecikar" required>
                   ...
                   <!-- Kısa İf Kulllanımı 
                    ...
                    <?php echo $uruncek['urun_onecikar'] == '1' ? 'selected=""' : ''; ?>
...
<div class="form-group">
 ...
 <div class="col-md-6 col-sm-6 col-xs-12">
   ...
   <textarea class="ckeditör" id="editör1"name="urun_detay" ><?php echo $uruncek['urun_detay']; ?></textarea>
 </div>
...
<div class="form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >Ürün Anahtarı <span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6 col-xs-12">
