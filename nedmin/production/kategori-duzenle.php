          ...
          <div class="x_content">
            ...
            <!-- / => en kök dizene çık
             ...
             <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <!--
input type="text" id="first-name" name="kategori_ad" value="<?php echo $_SERVER['HTTP_HOST']."/".$_SERVER['REQUEST_URI']?>/sayfa-<?php echo seo($kategoricek['kategori_ad']) ?>"required="required" class="form-control col-md-7 col-xs-12">
              -->
