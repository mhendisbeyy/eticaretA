          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="slider_icerik"  required="required" value="<?php echo $slidercek['slider_icerik'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="slider_fiyat"  required="required" value="<?php echo $slidercek['slider_fiyat'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
